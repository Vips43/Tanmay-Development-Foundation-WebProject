      ...
      <div className="footer-columns">
        ...
        <div className="footer-column">
          ...
          <ul>
            ...
            <li><Link to="/Gallery" className="no-underline">Gallery</Link></li>
            <li><Link to="/Media" className="no-underline">Media</Link></li>
            <li><Link to="/Careers" className="no-underline">Careers</Link></li>
            <li><Link to="/Certificate" className="no-underline">Certificate</Link></li>
          </ul>
        </div>
        ...
        <div className="footer-column">
          <h3>Support us</h3>
          <ul>
            <li><Link to="/faq" className="no-underline">FAQs</Link></li>
            <li><Link to="/contact" className="no-underline">Contact us</Link></li>
            <li><Link to="/support" className="no-underline">Support</Link></li>
            <li><Link to="/security" className="no-underline">Security</Link></li>
            <li><Link to="/center" className="no-underline">Center</Link></li>
          </ul>
        </div>
        ...
        <div className="footer-column">
          <h3>Contact us</h3>
          <a href="mailto:tanmayfoundation17@gmail.com" className="contact-email">tanmayfoundation17@gmail.com</a>
          <p>
            Address: <br />
