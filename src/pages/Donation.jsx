...
function Donation() {
  ...
  const fetchDonors = useMystore((state) => state.fetchDonors);
  const donors = useMystore((state) => state.donors);
  ...
  return (
    <div className="bg-[#ece5f0] font-montserrat">
            ...
            <section className="space-y-6">
              <div>
                ...
                <p className="text-gray-700 leading-relaxed">
                  Thankyou for being part of our journey and for helping
                  children in need . together we can Works closely with
                  institutions, corporate entities, government, local
                  communities and individuals to provide timely interventions in
                  water conservation, environment protection, rural development,
                  sustainable agriculture, sanitation and waste management,
                  women empowerment, education and skill development. .Tanmay
                  Development Foundation is a grassroots organization that aims
                  to bring qualitative improvement and change in the lives of
                  vulnerable people. The strength of Tanmay Development
                  Foundation is its strong community connect and its commitment
                  to the betterment of the underprivileged society.
                </p>
              </div>
              ...
              <div>
                ...
                <p className="text-gray-700 leading-relaxed">
                  Your Donations provide crucial financial resources that can be
                  used for various purposes such as funding programs,
                  maintaining operations, and investing in infrastructure and
                  education Overall, Each and Every donations play a critical
                  role in enabling organizations to achieve their mission, serve
                  their communities, and make a positive difference in the
                  world. Our Focus area-
                </p>
              </div>
            </section>
            ...
            <section className="border-4 border-[#F2B807] bg-white rounded-2xl shadow-lg p-6 w-full">
              <div className="space-y-8">
                ...
                <div className="space-y-3">
                  <p className="text-sm font-medium text-[#FF4420]">
                    Citizenship*
                  </p>
        ...
        <section className="my-16 space-y-8">
          <div className="text-center space-y-2">
            <h3 className="text-3xl font-bold text-gray-800">
              Our <span className="text-primary">Heroes</span>
            </h3>
          ...
          <div className="flex gap-6 overflow-x-auto pb-8 px-4 md:px-10 scrollbar-hidden snap-x">
            {donors.map((donor, index) => (
              <div
                key={index}
                className="snap-center shrink-0 w-72 bg-white rounded-2xl shadow-[0_8px_30px_rgb(0,0,0,0.06)] border border-gray-100 p-6 flex flex-col items-center text-center transition-transform hover:-translate-y-1 duration-300"
              >
                <div className="w-12 h-12 bg-green-100 rounded-full flex items-center justify-center mb-4 text-primary-light">
                  <FaHeart className="text-xl" />
                </div>

                <h3 className="text-gray-800 font-bold text-lg capitalize mb-1 truncate w-full">
                  {donor.name}
                </h3>

                <p className="text-gray-500 text-sm font-medium mb-4">
                  {donor.city || "India"}, {donor.state}
                </p>
                ...
                <p className="text-xs text-gray-400 mt-2">
                  Donated on{" "}
                  {new Date(donor.updatedAt).toLocaleDateString("en-IN", {
                    day: "numeric",
                    month: "short",
                    year: "numeric",
                  })}
      ...
      <div className="my-10">
        <img
          src="images/donation/wave-design.webp"
          alt="bottom wave"
